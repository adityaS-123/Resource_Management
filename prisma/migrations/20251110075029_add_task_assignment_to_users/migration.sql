...
CREATE TABLE "new_ResourceRequest" (
    ...
    CONSTRAINT "ResourceRequest_assignedToUserId_fkey" FOREIGN KEY ("assignedToUserId") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_ResourceRequest" ("approvedAt", "approvedById", "assignedToIT", "completedAt", "completedById", "completionNotes", "createdAt", "credentials", "currentLevel", "id", "itTaskDetails", "justification", "phaseId", "rejectionReason", "requestedConfig", "requestedQty", "requiredLevels", "resourceId", "resourceTemplateId", "resourceType", "status", "updatedAt", "userId") SELECT "approvedAt", "approvedById", "assignedToIT", "completedAt", "completedById", "completionNotes", "createdAt", "credentials", "currentLevel", "id", "itTaskDetails", "justification", "phaseId", "rejectionReason", "requestedConfig", "requestedQty", "requiredLevels", "resourceId", "resourceTemplateId", "resourceType", "status", "updatedAt", "userId" FROM "ResourceRequest";
